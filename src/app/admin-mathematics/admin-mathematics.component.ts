...
@Component({
  selector: 'app-admin-mathematics',
  templateUrl: './admin-mathematics.component.html',
  styleUrls: ['./admin-mathematics.component.css']
})
export class AdminMathematicsComponent {
