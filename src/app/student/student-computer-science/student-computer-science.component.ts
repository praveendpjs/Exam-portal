...
@Component({
  selector: 'app-student-computer-science',
  templateUrl: './student-computer-science.component.html',
  styleUrls: ['./student-computer-science.component.css']
})
export class StudentComputerScienceComponent {
