...
@Component({
  selector: 'app-student-chemistry',
  templateUrl: './student-chemistry.component.html',
  styleUrls: ['./student-chemistry.component.css']
})
export class StudentChemistryComponent {
