...
@Component({
  selector: 'app-student-physics',
  templateUrl: './student-physics.component.html',
  styleUrls: ['./student-physics.component.css']
})
export class StudentPhysicsComponent {
  ...
  ngOnInit():void{
    ...
    this.quiz.getCategoryPhysics().subscribe((result:any)=>{
        if(result){
